...
use BitBag\CodingStandard\Twigcs\Rule\Twig\QuoteInTwigRule;
use BitBag\CodingStandard\Twigcs\Ruleset\Ruleset;
use BitBag\CodingStandard\Twigcs\Util\HtmlUtil;
use FriendsOfTwig\Twigcs\Validator\Violation;

class QuoteInTwigRuleTest extends BaseIntegrationTest
{
    /** @var QuoteInTwigRule */
    private $rule;
    ...
    public function setUp(): void
    {
        ...
        $this->rule = new QuoteInTwigRule(Violation::SEVERITY_ERROR, new HtmlUtil());
    }
