...
return static function (ECSConfig $ecsConfig): void {
    ...
    $ecsConfig->ruleWithConfiguration(YodaStyleFixer::class, ['equal' => true, 'identical' => true, 'less_and_greater' => true,]);
    ...
    if (!in_array(getenv('ALLOW_BITBAG_OS_HEADER'), [false, 0, '0'], true)) {
        $ecsConfig->ruleWithConfiguration(HeaderCommentFixer::class, [
         ...
         $ecsConfig->skip([HeaderCommentFixer::class => ['Kernel.php', 'Migrations/*']]);
    }
